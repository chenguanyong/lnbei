...
class UserModel extends Model
{
    ...
    {
        return $this->cache(true,10)->page($Nowpage, $limits)->order('userId asc')->select(); 
    }
    ...
    {
        return $this->cache(true,10)->count();        
    }
    ...
    {
        return $this->cache(true,10)->where(array('userId'=>$id))->value('userStatus');
    }
    ...
    {
        return $this->cache(true,10)->where('userId', $id)->find();
    }
    ...
    public function getUser($loginName){
        ...
        return $this->cache(true,10)->where('loginName', $loginName)->find();
    }
