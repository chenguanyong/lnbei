<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\f\phpace_dev\public/../application/index\view\department\index.html";i:1504865551;}*/ ?>
<title>部门管理</title>
    ...
    jQuery(function ($)
    {
        ...
        var myTable =
            ...
            .DataTable(
            {
                ...
                "bProcessing" : true,
                "bServerSide" : true,
                "sAjaxSource" : new datatable().makeUrl(),//"<?php echo \think\Config::get('__PUBLIC__'); ?>/index/Department/getDepar?id=0",
            }
            );
    	...
    	$.validator.setDefaults({
    	    submitHandler: function() {
    	        ...
    	        $.post('<?php echo \think\Config::get('__PUBLIC__'); ?>/index/Department/setDepart',
    	        {
    	        	Name : $('#RoleName').val(),
    	        	shortname : $('#css').val(),
    	        	IsDelete : IsDelete,
